...
namespace RenderPipelineGraph {
    ...
    [UxmlElement]
    public partial class RPGNodeOuterEffect  : ImmediateModeElement, IDisposable {

       Material m_Mat;

        static Mesh s_Mesh;

        public RPGNodeOuterEffect()
        {
            RecreateResources();
        ...
        void RecreateResources()
        {
            ...
            if (m_Mat == null)
                m_Mat = new Material(Shader.Find("Hidden/RPG/NodeOuterGlow"));
        }
